...
class SettingsController extends Controller
{
     ...
     * @param string|null $nextcloud_cas_disable_logout
    ...
    public function saveSettings($cas_server_version, $cas_server_hostname, $cas_server_port, $cas_server_path, $cas_protected_groups, $cas_default_group, $cas_groups_letter_filter,
                                 ...
                                 $cas_disable_logout = NULL, $nextcloud_cas_disable_logout = NULL, $cas_use_proxy = NULL, $cas_import_merge = NULL, $cas_import_merge_enabled = NULL, $cas_groups_letter_umlauts = NULL, $cas_keep_ticket_ids = NULL)
    {
	    ...
	    $this->config->setAppValue($this->appName, 'nextcloud_cas_disable_logout', ($nextcloud_cas_disable_logout !== NULL) ? '1' : '0');
